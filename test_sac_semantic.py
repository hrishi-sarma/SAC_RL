...
class FurnitureRecommendationTesterSemantic:
    ...
    def visualize_layout(self, summary: dict, recommendations: list):
        ...
        plt.tight_layout()
        plt.savefig('/mnt/user-data/outputs/recommendation_layout_semantic.png', dpi=150, bbox_inches='tight')
        plt.close()
        print("Layout visualization saved to outputs/")
    ...
    def visualize_reward_breakdown(self, reward_details: list):
        ...
        plt.tight_layout()
        plt.savefig('/mnt/user-data/outputs/reward_breakdown_semantic.png', dpi=150, bbox_inches='tight')
        plt.close()
        print("Reward breakdown saved to outputs/")
    ...
    def batch_test(self, num_episodes: int = 20):
        ...
        plt.tight_layout()
        plt.savefig('/mnt/user-data/outputs/batch_test_results_semantic.png', dpi=150, bbox_inches='tight')
        plt.close()
        print("Batch test results saved to outputs/")
